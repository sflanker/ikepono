...
class Configuration:
    ...
    def validate(configuration):
        ...
        assert 8 == len(configuration["model"]), "Model configuration should have exactly 8 keys: backbone, pretrained, freeze, cut, dropout, hidden_units, output_vector_size, device"
    ...
    def defaults():
        ...
        configuration["model"] = {"backbone": "resnet18", "pretrained": True, "freeze": True, "cut": -1, "dropout": 0.5,
                              "hidden_units": 512, "output_vector_size": 128, "device": device}
